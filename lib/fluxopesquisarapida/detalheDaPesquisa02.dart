...
class DetalheDaPesquisa02 extends StatelessWidget {
  const DetalheDaPesquisa02({super.key});

  @override
  Widget build(BuildContext context) {
    return const DetalheDaPesquisa02Page();
  }
}

class DetalheDaPesquisa02Page extends StatefulWidget {
  const DetalheDaPesquisa02Page({Key? key}) : super(key: key);

  @override
  State<DetalheDaPesquisa02Page> createState() => _DetalheDaPesquisa02PageState();
}

class _DetalheDaPesquisa02PageState extends State<DetalheDaPesquisa02Page> {
