// 1.4 Detalhe Da Pesquisa Exame Recomendado
...
import 'package:vetadvisor/fluxopesquisarapida/detalheDaPesquisaRealizarNovaPesquisa.dart';
...
class DetalheDaPesquisaExameRecomendado extends StatelessWidget {
  const DetalheDaPesquisaExameRecomendado ({super.key});

  @override
  Widget build(BuildContext context) {
    return const DetalheDaPesquisaExameRecomendadoPage();
  }
}

class DetalheDaPesquisaExameRecomendadoPage extends StatefulWidget {
  const DetalheDaPesquisaExameRecomendadoPage({Key? key}) : super(key: key);

  @override
  State<DetalheDaPesquisaExameRecomendadoPage> createState() => _DetalheDaPesquisaExameRecomendadoState();
}

class _DetalheDaPesquisaExameRecomendadoState extends State<DetalheDaPesquisaExameRecomendadoPage> {
