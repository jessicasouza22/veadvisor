// 2.7.2 Consulta Tratamento Sintomatologico Posologia Texto Livre
...
class ConsultaTratamentoSintomatologicoPosologiaTextoLivre extends StatelessWidget {
  const ConsultaTratamentoSintomatologicoPosologiaTextoLivre ({super.key});

  @override
  Widget build(BuildContext context) {
    return const ConsultaTratamentoSintomatologicoPosologiaTextoLivrePage();
  }
}

class ConsultaTratamentoSintomatologicoPosologiaTextoLivrePage extends StatefulWidget {
  const ConsultaTratamentoSintomatologicoPosologiaTextoLivrePage({Key? key}) : super(key: key);

  @override
  State<ConsultaTratamentoSintomatologicoPosologiaTextoLivrePage> createState() => _ConsultaTratamentoSintomatologicoPosologiaTextoLivreState();
}

class _ConsultaTratamentoSintomatologicoPosologiaTextoLivreState extends State<ConsultaTratamentoSintomatologicoPosologiaTextoLivrePage> {
