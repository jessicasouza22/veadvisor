              ...
              child: Column(children: [
                ...
                Container(
                    ...
                    child: Row(children: [
                      Flexible(
                          child: AutoSizeText(
                            'Foi identificado aumento dos linfonodos submandibulares, hipertermia (39,9 graus), dor ao toque na região do ouvido, presença de ...',
                            style: TextStyle(
                              fontSize: 8,
                              color: Color(0xFF59616E),
                            ),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            "Pesquise os principais achados da anamnese e  ...",
                            style: TextStyle(
                              fontSize: 10,
                              color: Color(0xFF59616E),
                            ),
                          ...
                          Icon(MdiIcons.chevronDown,
                              color: Color(0xFF59616E), size: 10)
                        ],
                      ),
                    ],
                  ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Icon(MdiIcons.chevronDown,
                              color: Color(0xFF59616E), size: 18)
                        ],
                      ),
                    ],
                  ),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            "Pesquise os principais fatores de risco",
                            style: TextStyle(
                              fontSize: 10,
                              color: Color(0xFF59616E),
                            ),
